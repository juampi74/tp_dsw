...
@Component({
  selector: 'app-mar-table',
  standalone: true, // Permite que el componente se use sin necesidad de un módulo Angular tradicional
  templateUrl: './mar-table.component.html', // Ruta del archivo de plantilla HTML
  styleUrl: './mar-table.component.scss', // Ruta del archivo de estilos SCSS
  imports: [
    CommonModule,
    HttpClientModule,
